...
from .. import log
from explorer_app.api.featurize import *
from explorer_app.api.clean import lowercase, remove_stopwords, remove_punctuation
from explorer_app.api.select import projection, coordinate
    ...
    def run_operator(self, columns, operator, action, indices, visualization):
        ...
        if operator == "clean":
            ...
            if action == "projection":
                ...
                self.cached_visual_encodings[vis_name] = {
                    "scatterplot": visual_encoding
                }
